package org.zouzy.async.wrapper;

import org.zouzy.async.callback.DefaultCallback;
import org.zouzy.async.callback.ICallback;
import org.zouzy.async.entity.DependWrapper;
import org.zouzy.async.entity.ExecuteResult;
import org.zouzy.async.enums.ResultState;
import org.zouzy.async.enums.WorkStage;
import org.zouzy.async.exception.SkippedException;
import org.zouzy.async.executor.timer.SystemClock;
import org.zouzy.async.worker.IWorker;
...
import static org.zouzy.async.enums.WorkStage.*;
...
public class WorkerWrapper<T,V> {
     ...
     */
    private final AtomicReference<WorkStage> state = new AtomicReference<>(INIT);
