package io.github.bookiosk.log;

import io.github.bookiosk.AsyncManager;
import io.github.bookiosk.config.AsyncLogConfig;
import io.github.bookiosk.util.StrFormatter;

/**
 * @author bookiosk 2024-02-29
 */
public class AsyncLogForConsole implements AsyncLog{
    /**
     * 日志等级
     */
